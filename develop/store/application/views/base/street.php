		...
		<div class="row">
			<div class="col-md-12" id="main_page">
				<div class="panel panel-default">
					...
					<div class="col-md-6">
						<form class="form-inline" action="<?php echo base_url('base/street');?>" method="get">
	                ...
	                <?php
		              	if(isset($records)){
		              		foreach ($records as $row){
		              			...
		              			echo "<td><button class='delete　btn btn-xs btn-danger' value = '$row[street_id]'>删除</button></td>";
		              			echo "</tr>";
		              		}
              			}
              		?>
